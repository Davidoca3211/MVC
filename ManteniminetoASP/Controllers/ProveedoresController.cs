...
namespace ManteniminetoASP.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Nombre,Apellido,Telefono")] Proveedores proveedores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Nombre,Apellido,Telefono")] Proveedores proveedores)
        {
            if (ModelState.IsValid)
            {
